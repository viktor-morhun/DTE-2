            ...
            {currentSlide === 1 && (
              <div className="flex-1 flex flex-col">
                <div className="mb-[30px] min-h-[44px]">
                  <h2 className="text-[20px] leading-[24px] font-medium text-white">True or False: Naming the pressure you're feeling is a helpful first step to rebuilding confidence.</h2>
                </div>
              ...
              <div className="flex-1 flex flex-col relative">
                <div className="mb-[30px] min-h-[44px]">
                  <h2 className="text-[20px] leading-[24px] font-medium text-white">
                    What makes naming pressure and staying steady important for rebuilding confidence?
                  </h2>
                </div>
