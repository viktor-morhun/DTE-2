...
export default function Flashcards({
  ...
  const handleSlideChange = (swiper: SwiperType) => {
    ...
    // Reset audio started state when changing slides
  ...
  // Show swipe icon logic: for first 2 slides, but only after audio started for audio cards
  const shouldShowSwipe = currentCardIndex <= 1 && (
    activeCard?.type !== "audio" || audioStarted
  );
